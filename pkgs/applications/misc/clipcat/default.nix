...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "xrelkd";
    repo = pname;
    rev = "f0511db7e589435dc8246ea709292e3458c565c1";
    hash = "sha256-fXocfVQtnSEa/PXSQq+kqdPlvoxO1ZayxeOv9WGaRLw=";
  };

  cargoHash = "sha256-ITj54K8IaIxn5ASN+1vwextHVlkKZKB//eDp0WtNECc=";
